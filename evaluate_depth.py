...
import networks.must_net as networks
...
def evaluate(opt):
    ...
    if opt.ext_disp_to_eval is None:
        ...
        encoder_path = os.path.join(opt.load_weights_folder, "encoder_9800.pth")
        decoder_path = os.path.join(opt.load_weights_folder, "depth_9800.pth")
        ...
        with torch.no_grad():
            for data in dataloader:
                ...
                if opt.post_process:
                    ...
                    output = depth_decoder(encoder(input_color), 0, None)
