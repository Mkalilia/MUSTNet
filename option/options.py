...
file_dir = "" # the directory that options.py resides in
teacher_dir = ""
teacher_mask_dir = ""
flow_dir = ""
class MustNetOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--select_teacher",
                                 help="if use the adaptive co-teaching loss",
                                 default=False)
        self.parser.add_argument("--distill_train_mode",
                                 type=str,
                                 help="select distill the depth/pose model",
                                 choices=["depth", "pose"],
                                 default = "depth")
